    ...
    <div className="flex flex-col gap-5 animate-fade-in">
      ...
      <section className="relative overflow-hidden rounded-[28px] border border-border bg-card shadow-card">
        ...
        <div className="relative p-4 text-white">
          ...
          {/* Saldo utama */}
          <div className="mt-4 rounded-[24px] border border-white/20 bg-white/15 p-4 backdrop-blur-sm shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white/20 shadow-[0_4px_14px_rgba(255,255,255,0.08)]">
                {" "}
      ...
      <section className="rounded-[28px] border border-border bg-card p-6 shadow-card">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="shrink-0 rounded-2xl bg-amber-100 px-3 py-2 text-sm font-extrabold text-amber-800">
            {qurbanPct}%
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/25 shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
          <Icon className="h-4 w-4 text-white" />
        </div>

        {/* ARROW */}
        <ArrowRight className="h-4 w-4 text-white/85 transition-transform group-hover:translate-x-1" />
      </div>
